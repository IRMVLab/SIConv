...
def feature_encoding_layer(xyz, feature, npoint,size,layers,stride, mlp, radius, sigma, is_training, bn_decay, weight_decay, scope, bn=True, use_xyz=True, use_fd=True):
    ''' Input:
            xyz: (batch_size, ndataset, 3) TF tensor
            feature: (batch_size, ndataset, channel) TF tensor
            npoint: int32 -- #points sampled in farthest point sampling
    ...
    with tf.variable_scope(scope) as sc:
        ...
        weight_space=query_and_interpolation(xyz, feature, new_xyz,feature_density, l,layers)#(b,npoints,125,c)
...
def feature_decoding_layer(xyz1, points1,xyz2, points2, size,layers, stride, mlp, radius, sigma, is_training, bn_decay, weight_decay, scope, bn=True, use_xyz = True, use_fd=True):
    ''' Input:                                                                                                      
