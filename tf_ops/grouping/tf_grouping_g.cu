...
__global__ void query_ball_point_gpu(int b, int n, int m, int nsample, const float *radius, const float *xyz1, const float *xyz2, int *idx, int *pts_cnt) {
...
void queryBallPointLauncher(int b, int n, int m,  int nsample, const float *radius, const float *xyz1, const float *xyz2, int *idx, int *pts_cnt) {
    query_ball_point_gpu<<<b,256>>>(b,n,m,nsample,radius,xyz1,xyz2,idx,pts_cnt);
