...
class QueryBallPointGpuOp : public OpKernel {
    public:
        ...
        void Compute(OpKernelContext* context) override {
            ...
            OP_REQUIRES(context, radius_tensor.dims()==1, errors::InvalidArgument("QueryBallPoint expects (batch_size,) radius shape."));
            ...
            queryBallPointLauncher(b,n,m,nsample_,radius,xyz1,xyz2,idx,pts_cnt);
        }
    private:
        int nsample_;
};
