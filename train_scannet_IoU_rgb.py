...
parser.add_argument('--model', default='pointconv_weight_density_n16', help='Model name [default: model]')
parser.add_argument('--log_dir', default='log', help='Log dir [default: log]')
parser.add_argument('--num_point', type=int, default=8192, help='Point Number [default: 8192]')
parser.add_argument('--max_epoch', type=int, default=1001, help='Epoch to run [default: 501]')
...
DATA_PATH = '/data/scannet_pickle'#os.path.join(BASE_DIR, 'scannet')
...
def train_one_epoch(sess, ops, train_writer):
    ...
    for batch_idx in range(num_batches):
        ...
        aug_data = provider.rotate_point_cloud_z_rgb(batch_data)
